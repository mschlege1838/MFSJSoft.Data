...
namespace MFSJSoft.Data.Scripting
{
    ...
    ///         directive that specified the <see cref="DirectiveInitializationAction.DeferSetup"/> action in <see cref="InitDirective"/>.
    ...
    ///         <see cref="InitDirective"/> and (if applicable) <see cref="SetupDirective"/>. If <see cref="DirectiveInitializationAction.NoStore"/> 
    ...
    ///     </item>
    ///     <item>
    ///         <term><see cref="DirectiveInitializationAction.NoStore"/></term>
    ...
    ///     </item>
    ///     <item>
    ///         <term><see cref="DirectiveInitializationAction.ReplaceText"/></term>
    ///         <description>When specified on the return value from <see cref="InitDirective"/> or <see cref="SetupDirective"/>, the directive
    ...
    ///     </item>
    ///     <item>
    ///         <term><see cref="DirectiveInitializationAction.DeferSetup"/></term>
    ...
    ///         <see cref="DirectiveInitializationAction.NoStore"/>.</description>
    ///     </item>
    /// </list>
    /// 
    /// </remarks>
    public interface IScriptProcessor
    {
        ...
        /// every time a script is executed. Only called for directives that specified the <see cref="DirectiveInitializationAction.DeferSetup"/>
        ...
        /// </remarks>
        /// <param name="text">Final, resolved statement text, after all <see cref="DirectiveInitializationAction.ReplaceText"/>
